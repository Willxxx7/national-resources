<!--PATH: d2/d2-option2-text-analyzer/d2-php/index.php - DO NOT MODIFY-->
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>D2 - Text Analyzer (PHP)</title>
    <link rel="stylesheet" href="css/style.css" />
  </head>

  <body>
    <header>
      <h1>Text Content Analyzer - PHP</h1>
    </header>
    ...
    <main>
      <div class="analyzer-container">
        ...
        <div class="result-container">
          ...
          <div id="analysisResult">Submit text to see analysis</div>
        </div>
        ...
        <div class="validation-info">
          ...
          <ul>
            ...
            <li>Most common words (keyword density)</li>
          </ul>
        </div>
      </div>
    </main>
