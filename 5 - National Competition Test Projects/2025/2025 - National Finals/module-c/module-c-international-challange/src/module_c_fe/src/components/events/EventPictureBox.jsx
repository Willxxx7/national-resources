...
const EventPictureBox = ({picture, setBasketPicture, setPictureViewerModalVisible, setPictureViewerPicture}) => {
    ...
    return (
        <div
            ...
            <div className={"aspect-video w-full relative"}>
                ...
                {/*expand picture icon*/}
                <button onClick={() => {
                    setPictureViewerModalVisible(true);
                    setPictureViewerPicture(picture)
                }}
                        className={"absolute top-2 right-2 z-200 text-black bg-gray-50 lg:bg-gray-50/60 hover:bg-gray-50 text-4xl xl:hidden xl:group-hover:block cursor-pointer"}>
