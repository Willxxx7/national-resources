                    ...
                    <Routes>
                        ...
                        <Route element={<Auth/>}>
                            <Route path={"/profile"} element={<Profile/>}>
                                <Route index path={"/profile/details"} element={<Details/>}></Route>
                                <Route path={"/profile/orders"} element={<Orders/>}></Route>
                                <Route path={"/profile/orders/:id"} element={<OrderPage/>}></Route>
                                <Route path={"/profile/events"} element={<PrivateEvents/>}></Route>
                            </Route>
